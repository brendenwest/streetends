...
import {Text,TouchableHighlight, TextInput, StyleSheet, View} from "react-native";
...
export default class ContactForm extends Component {
  ...
  render(){
         return(
             ...
             <TextInput style={styles.input2} ref="body" placeholder="Enter your message" multiline= {true} />
