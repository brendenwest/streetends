...
const DetailsScreen = ({navigation}, props) => {
  ...
  const renderItem = ({item}) => (
    <TouchableHighlight
      onPress={getDetail.bind(this, item)}
      underlayColor="white">
      <View>
    ...
    <FlatList
      ListHeaderComponent={
        <>
          <Header />
          <Image
            source={{uri: 'https://i.imgur.com/XJFeun1.jpg'}}
      ...
      ListFooterComponent={
        <>
          <Text style={styles.titleText}>
            {'\n'}
            {'\n'}
            If you would like to leave a comment or concern about this street
            end, please submit below:
            {'\n'}
            {'\n'}
